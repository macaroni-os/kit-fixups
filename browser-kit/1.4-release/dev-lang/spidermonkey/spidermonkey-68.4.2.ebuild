...
src_prepare() {
	...
	eapply "${FILESDIR}/${P}-emitter_test.patch"
	eapply "${FILESDIR}/${P}-init_patch.patch"
	eapply "${FILESDIR}/${P}-spidermonkey_checks_disable.patch"
	eapply "${FILESDIR}/${P}-build-icu-big-endian.patch"
	eapply "${FILESDIR}/${P}-jstests_python-3.patch"
