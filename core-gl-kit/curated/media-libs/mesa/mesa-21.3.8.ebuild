...
IUSE="${IUSE_VIDEO_CARDS}
	+classic cpu_flags_x86_sse2 d3d9 debug +egl +gallium +gbm gles1 +gles2 +glvnd +llvm
...
RDEPEND="
	...
	${LIBDRM_DEPSTRING}[video_cards_freedreno?,video_cards_nouveau?,video_cards_vc4?,video_cards_vivante?,video_cards_vmware?]
	video_cards_intel? (
