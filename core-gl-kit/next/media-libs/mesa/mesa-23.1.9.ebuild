...
LLVM_MAX_SLOT="14"
LLVM_MIN_SLOT="14"
LLVM_USE_DEPS="llvm_targets_AMDGPU(+)"
PER_SLOT_DEPSTR="
	(
...
DEPEND="${RDEPEND}
	video_cards_d3d12? ( dev-util/directx-headers )
...
PATCHES=(
	...
	"${FILESDIR}/mesa-23.1.9-va-hack.patch"
)
...
pkg_setup() {
	...
	if use llvm && has_version sys-devel/llvm[!debug=]; then
		...
		ewarn "detected! his can cause problems. For details, see bug 459306."
	fi
