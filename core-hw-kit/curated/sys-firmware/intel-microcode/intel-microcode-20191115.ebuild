...
COLLECTION_SNAPSHOT="20191110"
GITHUB_REPO="Intel-Linux-Processor-Microcode-Data-Files"
GITHUB_USER="intel"
GITHUB_TAG="microcode-${PV}"
SRC_URI="!vanilla? ( https://dev.gentoo.org/~whissi/dist/intel-microcode/intel-microcode-collection-${COLLECTION_SNAPSHOT}.tar.xz )
