...
SRC_URI+=" mirror://gentoo/${MY_P}.tar.xz mirror://funtoo/grub/${BINFONT}.xz"
...
SLOT="2/${PVR}"
IUSE="+binfont debug device-mapper doc efiemu +fonts mount multislot nls static sdl test +themes truetype libzfs"
...
DEPEND="${RDEPEND}
	...
	themes? ( app-arch/unzip media-libs/freetype:2 )
"
RDEPEND+="
	kernel_linux? (
...
pkg_postinst() {
	...
	if has_version 'sys-boot/grub:0'; then
		...
		elog "    https://www.gentoo.org/doc/en/grub2-migration.xml"
	fi
}
