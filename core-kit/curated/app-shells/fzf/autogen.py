...
async def generate(hub, **pkginfo):
	...
	version = pkginfo['version'] = latest_release["tag_name"]
	pkginfo['artifacts'] = { "main" : hub.pkgtools.ebuild.Artifact(url=f"https://github.com/{user}/{repo}/archive/{version}.tar.gz", final_name=f"{repo}-{version}.tar.gz") }
