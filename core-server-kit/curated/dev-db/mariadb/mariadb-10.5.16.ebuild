...
src_prepare() {
        eapply "${FILESDIR}/10.5/0001-cmake-build-without-client-libs-and-tools.patch"
        eapply "${FILESDIR}/10.5/0002-libmariadb-fix-mysql_st-API-regression.patch"
        eapply "${FILESDIR}/10.5/0003-libmariadb-cmake-find-GSSAPI-via-pkg-config.patch"
        eapply "${FILESDIR}/10.5/0004-cmake-don-t-install-mysql-d-.service-symlinks.patch"
