...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-3.0.2-explicit-python.patch
	"${FILESDIR}"/${PN}-3.0.4-enchant-2.patch # backport
	"${FILESDIR}"/${PN}-3.0.4-pygobject.patch
	"${FILESDIR}"/${PN}-3.0.4-asio-standalone-placeholders.patch
	"${FILESDIR}"/${PN}-3.0.4-c++17-dynamic-exception-specifications.patch
