...
wasi=$(echo "https://crates.io/api/v1/crates/wasi/0.9.0+wasi-snapshot-preview1/download -> wasi-0.9.0+wasi-snapshot-preview1.crate")

# echo https://crates.io/api/v1/crates/${name}/${version}/download -> ${crate}.crate
