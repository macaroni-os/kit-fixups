...
RDEPEND="${COMMON_DEPEND}
	...
	>=gnome-extra/cinnamon-settings-daemon-3.4
...
src_prepare() {
	...
	# upstream backport for HiDPI issues. https://github.com/linuxmint/Cinnamon/commit/273aff4c6a7fa8ee6a70196d24e5ab9b39aa7e50. https://bugs.funtoo.org/browse/FL-3880
	eapply "${FILESDIR}"/${PN}-switcher.patch
