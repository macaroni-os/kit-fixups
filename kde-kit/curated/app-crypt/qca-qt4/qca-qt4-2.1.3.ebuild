...
IUSE="botan debug doc examples gcrypt gpg libressl logger nss pkcs11 +qt4 sasl softstore +ssl test"
...
PATCHES=(
	"${FILESDIR}/qca-disable-pgp-test.patch"
	"${FILESDIR}/qca-2.1.3-c++11.patch"
)
