...
src_prepare() {
	...
	# https://bugs.funtoo.org/browse/FL-3850. fix imagemagick compatibility
	sed -i -e 's|wand/magick_wand.h|MagickWand/MagickWand.h|' src/video_dec/image.c || die "sed failed"
