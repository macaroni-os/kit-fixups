	...
	def __init__(self, config):
		...
		self.kit_groups = {
			'2.0-beta': [
				...
				{'name': 'gnome-kit', 'branch': '3.36-prime', 'stability': KitStabilityRating.PRIME, "type": KitType.INDEPENDENTLY_MAINTAINED},
			...
			'1.4-release': [
				...
				{'name': 'gnome-kit', 'branch': '3.34.4-testing', 'stability': KitStabilityRating.BETA, "type": KitType.INDEPENDENTLY_MAINTAINED},
