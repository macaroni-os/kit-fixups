...
WEBAPP_OPTIONAL="yes"
inherit flag-o-matic webapp java-pkg-opt-2 user systemd toolchain-funcs go-module
...
KEYWORDS="*"
IUSE="+agent agent2 java curl frontend ipv6 xmpp ldap libxml2 mysql odbc openipmi oracle +postgres proxy server ssh ssl snmp sqlite static webservice"
