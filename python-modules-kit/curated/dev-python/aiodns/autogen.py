...
async def generate(hub, **pkginfo):
	...
	if version == "2.0.0":
		...
		artifact = hub.pkgtools.ebuild.Artifact(url=f'https://www.github.com/{GITHUB_USER}/{GITHUB_REPO}/tarball/{GITHUB_COMMIT}', final_name=f"{pkginfo['name']}-{GITHUB_COMMIT}.tar.gz")
