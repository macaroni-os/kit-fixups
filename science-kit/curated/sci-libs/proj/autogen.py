...
async def generate(hub, **pkginfo):
	...
	datum_artifact = hub.pkgtools.ebuild.Artifact(url=f"https://download.osgeo.org/proj/{pkginfo['name']}-datumgrid-latest.tar.gz")
	europe_datum_artifact = hub.pkgtools.ebuild.Artifact(url=f"https://download.osgeo.org/proj/{pkginfo['name']}-datumgrid-europe-latest.tar.gz")
